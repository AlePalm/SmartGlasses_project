...
ErrorCode I2C_Peripheral_ReadRegister(uint8_t device_address, 
    ...
    //Return
    // Question the error variable, because we know it can assume 2 values: error/no error
    // Which is the value of the error? If it is ERROR ruturn 1, vice versa return 0
