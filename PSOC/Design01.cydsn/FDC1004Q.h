...
*/
    ...
    */
    ...
    /**
    *   Initialize the channels so that they are ready for measurement
    */
    void Setup_Channels(void);
    
    /**
    *   Set capdac, gain and offset values and initialize register 0x0C
    */
    ...
    */
    ...
    uint8_t FDC_ReadMeasurement(uint8_t channel, double* capacitance141);
